...
public static class TransformExtensions
{
    ...
    public static Vector3 Difference(this Transform transform1, Transform transform2)
    {
        return transform1.position - transform2.position;
    }

    public static float Distance3Sqr(this Transform transform1, Transform transform2)
    {
        return (transform1.position - transform2.position).sqrMagnitude;
    }
    public static float Distance2Sqr(this Transform transform1, Transform transform2)
    {
        return (transform1.position - transform2.position).SqrMagnitudeXY();
    }
